...
function createMpesaForm() {
  return `
    ...
    <div style="background: #fff3cd; padding: 15px; border-radius: 8px; margin: 15px 0;">
      ...
      <p>1. Send <strong>KSH ${(selectedPlan.price * 130).toFixed(0)}</strong> to <strong>0768012671</strong></p>
...
function createCryptoForm() {
  return `
    ...
    <div style="background: #fff3cd; padding: 15px; border-radius: 8px; margin: 15px 0;">
      <p><strong>Crypto Payment Instructions:</strong></p>
      <p>1. Send equivalent of <strong>$${selectedPlan.price}</strong> in crypto to our wallet</p>
      <p>2. Upload transaction proof below</p>
      <p>3. Your subscription will be activated within 24 hours</p>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" id="cryptoTransactionId" placeholder="Transaction hash" required>
    </div>
    <div class="form-group">
