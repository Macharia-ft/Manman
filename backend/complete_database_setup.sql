...
SELECT 'matches table created' as status, count(*) as record_count FROM matches
UNION ALL
SELECT 'user_interactions table created' as status, count(*) as record_count FROM user_interactions
UNION ALL
SELECT 'subscriptions table created' as status, count(*) as record_count FROM subscriptions;
