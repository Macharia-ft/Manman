...
CREATE TABLE pending_premium_subscriptions (
    ...
    payment_method VARCHAR(50) NOT NULL CHECK (payment_method IN ('mpesa', 'crypto', 'paypal', 'credit_card')),
...
CREATE TABLE subscriptions (
    ...
    user_email VARCHAR(255) NOT NULL,
    plan VARCHAR(50) NOT NULL CHECK (plan IN ('free', 'weekly', 'monthly', 'yearly')),
